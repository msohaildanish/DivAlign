...
def do_train(
    ...
    for iteration, (images, targets, _) in enumerate(data_loader, start_iter):
        ...
        images.tensors = images.tensors.view(B*A, C, H, W)
        new_sizes = []
        for sz in images.image_sizes:
            new_sizes.extend([sz]*A)
        images.image_sizes = new_sizes
        images = images.to(device)
        targets = [target.to(device) for target_ in targets for target in target_]
